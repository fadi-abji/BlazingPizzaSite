    ...
    public partial class inital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 11.99m, "It has EVERY kind of bacon", "img/pizzas/bacon.jpg", "The Baconatorizor" },
                    { 2, 12.75m, "Spicy chicken, hot sauce, and blue cheese, guaranteed to warm you up", "img/pizzas/meaty.jpg", "Buffalo chicken" },
                    { 3, 11.5m, "It's like salad, but on a pizza", "img/pizzas/salad.jpg", "Veggie Delight" },
                    { 4, 9.99m, "Traditional Italian pizza with tomatoes and basil", "img/pizzas/margherita.jpg", "Margherita" },
                    { 5, 11.99m, "It's cheesy and delicious. Why wouldn't you want one?", "img/pizzas/cheese.jpg", "Basic Cheese Pizza" },
                    { 6, 10.5m, "It's the pizza you grew up with, but Blazing hot!", "img/pizzas/pepperoni.jpg", "Classic pepperoni" }
                });
